...
if(!$isLogged){
    echo "<br/><br/><p style='font-size:16px;color:red;height:340px'>Para ver los productos de nuestro catálogo es necesario que se <a style='font-size:16px' href='index.php?route=account/register'>registre</a> o que <a style='font-size:16px' href='index.php?route=account/login'>inicie sesión</a> <br/><br/> Muchas gracias.</p>";
    $showProducts = false;
    ?>
    </div>
    <?php
...
<div id="content" style="padding-top: 0px; margin-left: 0;"><?php echo $content_top; ?>
  <div class="product-info">
    ...
    <div class="left" style="border: none;">
      ...
      <div class="zoom-small-image"><a href="<?php echo $popup; ?>" class = 'cloud-zoom' id='zoom1' rel="adjustX: 10, adjustY:-4" title="<?php echo $heading_title; ?>" class="colorbox" rel="colorbox"><img style="border: 1px solid #CCC;" width="295" src="<?php echo $thumb; ?>" id="image"  /></a></div>
      </div>
      <?php } ?>
      <?php if ($images) { ?>
    ...
    <div class="left" style="border: none; margin-top: 15px; width: 325px;">
      ...
      <div class="price"><span class="price_text">Colores</span>
        <span class="price_span"><img style="max-width: 150px;" src="image/<?php echo $colores; ?>"/></span>
      </div>
      <?php } ?>
      <?php if ($options) { ?>
  ...
  <div class="left right-info">
    <div class="envios">
      <div class="item">
        <span class="logo camion"></span>
        <span class="text">Envio a través de su expreso de confianza</span>
        <div class="clear"></div>
      </div>
      <div class="item">
        <span class="logo pesos"></span>
        <span class="text">Compra mínima $4000. A partir de $8000 desc. 20%</span>
        <div class="clear"></div>
      </div>
      <div class="item doble">
        <span class="logo hora"></span>
        <span class="text-double">Horario de atención</span>
        <span class="text-double">Lunes a viernes de 9 a 18 hs.</span>
        <div class="clear"></div>
      </div>
      <div class="item doble">
        <span class="logo tel"></span>
        <span class="text-double">Info y ventas</span>
        <span class="text-double">(011) 4637-6203 ó 4611-4762</span>
        <div class="clear"></div>
      </div>
    </div>
    <div class="img">
    ...
    <div class="img">
      <img src="image/detalle_producto/tienda_online.png" />
    </div>
  </div>
  </div>
  ...
  <div class="banners_detalle">
    <!--img class="tienda_online" src="image/detalle_producto/tienda_online.jpg"/>-->
    <img class="envios_detalle" src="image/detalle_producto/envios_detalle.png"/>
  </div>
  <?php if ($products) { ?>
