...
class ModelCheckoutOrder extends Model {
    ...
    public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
        ...
        if ($order_info ) {/*&& !$order_info['order_status_id']*/
            ...
            $template->data['link'] = $order_info['store_url'];
			...
			//Esta forma de envio no me está andando..por eso hago la de abajo.
            $mail = new Mail();
            ...
            if ($this->config->get('config_alert_mail')) {
                ...
                $text .= $language->get('text_new_order_client') . ' ' . $order_info['payment_firstname'] . ' ' . $order_info['payment_lastname'] . ', ' . $order_info['email'] . "\n";
                $text .= $language->get('text_new_order_id') . ' ' . $order_id . "\n";
                $text .= $language->get('text_new_date_added') . ' ' . date($language->get('date_format_short'), strtotime($order_info['date_added'])) . "\n";
                $text .= $language->get('text_new_order_status') . ' ' . $order_status . "\n\n";
                $text .= $language->get('text_new_products') . "\n";
